...
An account is an entity that is identified by a unique [address](https://docs.pactus.org/docs/concepts/blockchain/address),
...
- **Number** is a sequential and unique number assigned to each account when it is created for the first time.
  The account number is used to calculate the [state hash](https://docs.pactus.org/docs/concepts/blockchain/state-hash) of the blockchain.
...
The [address type](https://docs.pactus.org/docs/concepts/blockchain/address/#address-type) is 0, and therefore,
